...
/*국가명 = " 아르헨티나, 오스트리아, 오스트레일리아, 벨기에, 브라질, 캐나다, 스위스, 칠레, 콜롬비아, 체코
...
싱가포르, 태국, 터키, 대만, 우크라이나, 미국, 베트남
*/
var countries = ["AR", "AT", "AU", "BE", "BR", "CA", "CH", "CL", "CO", "CZ",
				"DE", "DK", "EG","FI", "FR", "GB", "GR", "HK", "HU", "ID",
				"IE", "IL", "IN", "IT", "JP", "KE", "KR", "MX", "MY", "NG",
				"NL", "NO", "NZ", "PH", "PL", "PT", "RO", "RU", "SA", "SE",
				"SG", "TH", "TR", "TW", "UA", "US", "VN"];

var transLangs = ["es", "de", "en", "fr", "pt", "en", "de", "es", "es", "cs",
